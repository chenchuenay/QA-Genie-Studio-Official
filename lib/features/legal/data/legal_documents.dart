...
1. Introduction
I provide QA Genie, a hybrid-powered test case generation tool for quality assurance professionals. I collect only what is necessary to deliver the service. This policy explains what data I collect and how it is handled.
...
QA Genie uses the following third-party services:
...
QA Genie is not intended for children under 13. I do not knowingly collect personal information from children.
...
Rate limits: Maximum 10 generation requests per minute; 5 issue reports per minute. Automated scraping, quota bypass, or abuse of the service is strictly prohibited and will result in account suspension.
...
- I use idempotency keys (requestId) to prevent duplicate processing
...
See my Privacy Policy for complete details on data handling.
...
12. Advertising
QA Genie displays rewarded video ads via Google AdMob with Unity Ads as a mediated partner. Watching an ad is voluntary and rewards are provided at my discretion. I do not display interstitial or banner advertisements. Refer to my Ads & Monetization Policy for full details.
...
Human review required. You are solely responsible for reviewing, validating, and verifying all generated content before use. Generated test cases are a starting point, not a final product. I make no warranties regarding completeness, accuracy, or fitness for purpose of generated content. See my AI Disclaimer for full details.

14. Disclaimer of Warranties
THE APP IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, ACCURACY, AND NON-INFRINGEMENT. I DO NOT WARRANT THAT THE APP WILL BE UNINTERRUPTED, ERROR-FREE, SECURE, OR THAT GENERATED TEST CASES WILL MEET YOUR REQUIREMENTS.
...
Generated test cases are suggestions only. You are responsible for reviewing, validating, and adapting them before use. I am not liable for any loss, damage, or claim arising from the use of generated test cases in any environment.

16. Termination
I reserve the right to suspend or terminate your access to the App at my sole discretion, without prior notice, for conduct that I believe violates these Terms or is harmful to other users, third parties, or the App itself. You may stop using the App at any time and delete your account through the App settings.

17. Changes to These Terms
I may update these Terms from time to time. Updated Terms will be posted on this page with an updated "Last updated" date. Continued use of the App after changes constitutes acceptance of the updated Terms. Material changes will be communicated in-app.
...
QA Genie utilizes inference models to assist in the creation of test scenarios, test steps, and quality assurance documentation. While the engine is engineered to provide high-quality, relevant test data, it is imperative to understand the following:
...
- A transaction token is generated upon ad completion and sent to my backend for verification
- Ad completion is verified server-side using a cryptographically random transaction token
- Attempting to spoof ad completion or bypass ad requirements violates my Terms of Service and may result in account suspension
...
3. Ad-Free Pro Tier
PRO tier users experience no ads and bypass all ad-supported limitations. PRO status is managed via internal subscription verification logic. If you believe your PRO status is not correctly applied, please contact me through the app's Support → Report an Issue.

4. No Intrusive Ads
I do not serve interstitial, banner, or native ads during your workflow. The only ad format is rewarded video, triggered only by your explicit action:
- No pop-ups
- No auto-playing ads
...
5. Ad Integrity
Ad completion is verified server-side using a cryptographically random transaction token. Attempting to spoof ad completion or bypass ad requirements violates my Terms of Service and may result in account suspension.
...
In-App Deletion
Open QA Genie → Account → Delete Account. This removes your profile, usage data, synced test cases, and authentication credentials from my servers. After deletion, you will be signed out and a new guest session will be created automatically.
