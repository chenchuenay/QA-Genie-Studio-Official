    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          _featureRow("Test cases per batch", "8", "16"),
          _featureRow("Requests per day", "Ad Sponsored", "15"),
          _featureRow("Exports", "Ad Sponsored", "Unlimited"),
          _featureRow("Test summary reports", "Ad Sponsored", "Unlimited"),
          _featureRow("Ads", "Yes", "No"),
          const SizedBox(height: 28),
          const Text("\$7.99 / month", style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
